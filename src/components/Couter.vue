...
<div class="m-8 flex flex-col flex-grow" role='application'>
  ...
  <div class="flex flex-grow justify-center items-center text-9xl font-black my-4 mx-2 text-gray-600">
    {{ count }}
  </div>
  <div class="flex gap-4 mt-4">
    <button @click="addCount" class="btn-count text-gray-500">ADD</button>
    <button @click="reset" class="btn-count border-yellow-300 text-yellow-600">RESET</button>
  </div>
</div>
</template>
